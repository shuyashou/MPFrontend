...
export const b2cPolicies = {
    names: {
        signUpSignIn: 'B2C_1_sign_up_sign_in_1',
        forgotPassword: 'B2C_1_password_reset',
        editProfile: 'B2C_1_profile_edit',
    },
    authorities: {
        signUpSignIn: {
            authority: 'https://thomas1n.b2clogin.com/thomas1n.onmicrosoft.com/B2C_1_sign_up_sign_in_1',
        },
        forgotPassword: {
            authority: 'https://thomas1n.b2clogin.com/thomas1n.onmicrosoft.com/B2C_1_password_reset',
        },
        editProfile: {
            authority: 'https://thomas1n.b2clogin.com/thomas1n.onmicrosoft.com/B2C_1_profile_edit',
        },
    },
    authorityDomain: 'thomas1n.b2clogin.com',
};
